...
def check_and_update():
    ...
    if not desktop_shortcut.exists():
        try:
            ps_cmd = f" = New-Object -ComObject WScript.Shell;  = .CreateShortcut('{str(desktop_shortcut)}'); .TargetPath = '{str(BASE_DIR / 'run_alfraganus.bat')}'; .WorkingDirectory = '{str(BASE_DIR)}'; .Description = 'Alfraganus AI - Autonomous PC Agent'; .IconLocation = 'C:\\Windows\\System32\\shell32.dll, 15'; .Save()"
    ...
    print("====================================================")
    print("  ? YANGILANISh TAYYOR ? DASTUR ISHGA TUSHMOQDA...")
    print("====================================================\n")
